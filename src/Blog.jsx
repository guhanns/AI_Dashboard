  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-semibold text-gray-800">Blog List</h2>
        ...
        <Table bordered hover responsive className="min-w-full text-sm text-gray-700 bg-white border border-gray-200">
          ...
          <tbody>
            <tr className="hover:bg-blue-50 transition-colors">
              ...
              <td>Jane Smith</td>
              <td>2024-06-01</td>
              <td><span className="inline-block px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded">Published</span></td>
              <td>
